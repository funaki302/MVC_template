...
final class DeferredContent
{
	...
	private function buildJsCss(): string
	{
		$css = array_map('file_get_contents', array_merge([
			__DIR__ . '/..<?= BASE_URL ?>/assets/reset.css',
			__DIR__ . '/../Bar<?= BASE_URL ?>/assets/bar.css',
			__DIR__ . '/..<?= BASE_URL ?>/assets/toggle.css',
			__DIR__ . '/..<?= BASE_URL ?>/assets/table-sort.css',
			__DIR__ . '/..<?= BASE_URL ?>/assets/tabs.css',
			__DIR__ . '/../Dumper<?= BASE_URL ?>/assets/dumper-light.css',
			__DIR__ . '/../Dumper<?= BASE_URL ?>/assets/dumper-dark.css',
			__DIR__ . '/../BlueScreen<?= BASE_URL ?>/assets/bluescreen.css',
		], Debugger::$customCssFiles));

		$js1 = array_map(fn($file) => '(function() {' . file_get_contents($file) . '})();', [
			__DIR__ . '/../Bar<?= BASE_URL ?>/assets/bar.js',
			__DIR__ . '/..<?= BASE_URL ?>/assets/toggle.js',
			__DIR__ . '/..<?= BASE_URL ?>/assets/table-sort.js',
			__DIR__ . '/..<?= BASE_URL ?>/assets/tabs.js',
			__DIR__ . '/..<?= BASE_URL ?>/assets/helpers.js',
			__DIR__ . '/../Dumper<?= BASE_URL ?>/assets/dumper.js',
			__DIR__ . '/../BlueScreen<?= BASE_URL ?>/assets/bluescreen.js',
		]);
