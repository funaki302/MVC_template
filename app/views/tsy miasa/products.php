...
<head>
    ...
    <!-- ApexCharts CDN -->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>  <script type="module" crossorigin src=".<?= BASE_URL ?>/assets/vendor-bootstrap-C9iorZI5.js"></script>
  ...
  <script type="module" crossorigin src=".<?= BASE_URL ?>/assets/products-WhFVlziX.js"></script>
