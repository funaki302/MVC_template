...
<script type="module" crossorigin src=".<?= BASE_URL ?>/assets/users-B_8qHPdr.js"></script>
...
<body data-page="users" class="user-management">
    ...
    <!-- Scripts -->
    <script nonce="<?= htmlspecialchars($cspNonce) ?>" src="<?= $baseUrl ?>/assets/js/user.js"></script>
